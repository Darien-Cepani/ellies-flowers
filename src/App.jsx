          ...
          <div className="flex animate-infinite-scroll gap-10 sm:gap-20 text-base sm:text-lg md:text-xl tracking-[0.4em] uppercase font-display font-light items-center">
            {[0, 1].map((dup) => (
              <React.Fragment key={dup}>
                ...
                <span className="font-serif italic font-medium tracking-[0.3em]">Hand-Tied</span> <span className="text-brand-deep opacity-60">❀</span>
                <span className="font-display font-bold tracking-[0.25em]">Roses</span> <span className="text-brand-deep opacity-60">❀</span>
                <span className="font-serif font-normal uppercase tracking-[0.4em]">Peonies</span> <span className="text-brand-deep opacity-60">❀</span>
                ...
                <span className="font-serif italic font-semibold tracking-[0.3em] text-brand-deep">Bespoke</span> <span className="text-brand-deep opacity-60">❀</span>
