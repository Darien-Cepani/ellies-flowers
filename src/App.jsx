...
const PRODUCTS = [
  {
    id: 1,
    name: { en: "Coral Peony & Viburnum Vase", sq: "Vazo me Bozhure Korale dhe Viburnum" },
    category: "arrangements",
    image: "ig/ig01.jpg",
    description: {
      en: "A lavish vase arrangement of coral-pink peonies paired with soft green hydrangea and viburnum, presented in a clear glass vase ready to display.",
      sq: "Një kompozim i harlisur në vazo me bozhure ngjyrë koral-rozë, të shoqëruara me hortensie dhe viburnum jeshil të butë, të paraqitura në një vazo qelqi gati për t'u shfaqur."
    },
    details: {
      en: ["Coral & soft-green palette", "Arrives in a glass vase", "Same-day delivery in Tirana"],
      sq: ["Paletë koral & jeshile e butë", "Vjen në një vazo qelqi", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 2,
    name: { en: "Red Tulip Spring Bouquet", sq: "Buqetë Pranverore me Tulipanë të Kuq" },
    category: "bouquets",
    image: "ig/ig02.jpg",
    description: {
      en: "A cheerful hand-tied bouquet of red-and-white tulips nestled in their own fresh leaves and finished in a deep-green wrap.",
      sq: "Një buqetë e gëzueshme e punuar me dorë me tulipanë të kuq e të bardhë, të rrethuar nga gjethet e tyre të freskëta dhe të mbështjellë në letër jeshile të errët."
    },
    details: {
      en: ["Fresh seasonal tulips", "Red & white two-tone blooms", "Same-day delivery in Tirana"],
      sq: ["Tulipanë sezonalë të freskët", "Lule dyngjyrëshe të kuqe e të bardha", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 3,
    name: { en: "Romantic Pastel Garden Bouquet", sq: "Buqetë Romantike Kopshti në Tone Pastel" },
    category: "bouquets",
    image: "ig/ig03.jpg",
    description: {
      en: "A generous hand-tied bouquet mixing pink and lavender roses, ruffled spray roses, and fresh green viburnum, wrapped in natural kraft paper.",
      sq: "Një buqetë bujare e punuar me dorë që ndërthur trëndafila rozë e lejla, trëndafila spray me valë dhe viburnum jeshil të freskët, të mbështjellë në letër kraft natyrale."
    },
    details: {
      en: ["Pink, lavender & cream palette", "Large, lush hand-tie", "Same-day delivery in Tirana"],
      sq: ["Paletë rozë, lejla & krem", "I madh e i harlisur, i lidhur me dorë", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 4,
    name: { en: "Blush Peony & Viburnum Bouquet", sq: "Buqetë me Bozhure Rozë të Butë dhe Viburnum" },
    category: "bouquets",
    image: "ig/ig04.jpg",
    description: {
      en: "A soft, romantic bouquet of blush garden roses and pink peonies set against rounded green viburnum and feathery greenery.",
      sq: "Një buqetë e butë dhe romantike me trëndafila kopshti rozë e bozhure, të vendosura mbi viburnum jeshil të rrumbullakët dhe gjelbërim të imët."
    },
    details: {
      en: ["Blush pink & green palette", "Garden roses & peonies", "Same-day delivery in Tirana"],
      sq: ["Paletë rozë e butë & jeshile", "Trëndafila kopshti & bozhure", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 5,
    ...
    image: "ig/ig05.jpg",
    description: {
      en: "A show-stopping dome of deep red roses tied into a full round bouquet and dramatically wrapped in matte black paper.",
      sq: "Një kube mahnitëse trëndafilash të kuq të errët, të lidhur në një buqetë të plotë e të rrumbullakët dhe të mbështjellë në mënyrë dramatike me letër të zezë mat."
    },
    details: {
      en: ["Premium long-stem red roses", "Available in 50 / 101 stems", "Perfect for anniversaries"],
      sq: ["Trëndafila premium me kërcell të gjatë", "Disponohet me 50 / 101 kërcej", "Ideale për përvjetorë"]
    }
  },
  {
    id: 6,
    name: { en: "Eternal Roses Glass Dome", sq: "Kube Qelqi me Trëndafila të Përjetshëm" },
    category: "roses",
    image: "ig/ig06.jpg",
    description: {
      en: "Real preserved red roses arranged inside an elegant glass dome — a lasting keepsake that needs no water and stays beautiful for years.",
      sq: "Trëndafila të kuq të vërtetë e të ruajtur, të rregulluar brenda një kube elegante qelqi — një kujtim i përjetshëm që nuk ka nevojë për ujë dhe qëndron i bukur me vite."
    },
    details: {
      en: ["Real preserved roses", "Lasts 1–3 years, no water", "Gift-boxed glass dome"],
      sq: ["Trëndafila të vërtetë të ruajtur", "Zgjat 1–3 vjet, pa ujë", "Kube qelqi në kuti dhuratë"]
    }
  },
  {
    id: 7,
    name: { en: "Pink & Cream Rose Bouquet", sq: "Buqetë me Trëndafila Rozë dhe Krem" },
    category: "bouquets",
    image: "ig/ig07.jpg",
    description: {
      en: "A luxurious hand-tied bouquet of magenta, lavender, and cream roses gathered closely and wrapped in soft ivory paper.",
      sq: "Një buqetë luksoze e punuar me dorë me trëndafila magenta, lejla dhe krem, të mbledhura ngushtë dhe të mbështjellë në letër fildishi të butë."
    },
    details: {
      en: ["Magenta, lilac & cream roses", "Lush round hand-tie", "Same-day delivery in Tirana"],
      sq: ["Trëndafila magenta, lejla & krem", "I harlisur e i rrumbullakët, i lidhur me dorë", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 8,
    name: { en: "Coral Garden Rose & Anthurium Bouquet", sq: "Buqetë me Trëndafila Kopshti Korale dhe Anthurium" },
    category: "weddings",
    image: "ig/ig08.jpg",
    description: {
      en: "An elegant statement bouquet of ruffled coral garden roses crowned with bold green anthurium leaves, wrapped in crisp white and tied with ribbon.",
      sq: "Një buqetë elegante e dukshme me trëndafila kopshti koral me valë, e kurorëzuar me gjethe të theksuara jeshile anthurium, e mbështjellë në të bardhë të pastër dhe e lidhur me fjongo."
    },
    details: {
      en: ["Coral roses & green anthurium", "Refined white presentation wrap", "Ideal for weddings & events"],
      sq: ["Trëndafila koral & anthurium jeshil", "Mbështjellje e rafinuar e bardhë", "Ideale për dasma & evente"]
    }
  }
];
    ...
    <svg viewBox="0 0 64 64" className={className} fill="none" aria-hidden="true">
      <g fill="currentColor">
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
          <ellipse key={deg} className="brand-petal" cx="32" cy="16.5" rx="4.6" ry="13" transform={`rotate(${deg} 32 32)`} />
        ))}
      </g>
...
export default function App() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen font-sans antialiased text-brand-dark selection:bg-brand-gold/25 selection:text-brand-dark md:select-none bg-white overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle at 50% 42%, rgba(197,107,90,0.16), transparent 58%)' }} />
        ...
        <div className="hidden lg:grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-end gap-5">
            ...
            <a
              ...
              onMouseLeave={() => triggerCursor("", false)}
              className="flex items-center gap-1.5 bg-white text-brand-dark hover:bg-brand-deep hover:text-white transition-colors duration-300 rounded-md px-5 py-2.5 text-[10px] font-display tracking-[0.2em] uppercase font-semibold"
            >
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-6 py-6 flex flex-col">
          {NAV_CATEGORIES.map((cat) => (
            <button
              ...
              className="group flex items-center justify-between py-4 border-b border-brand-champagne text-2xl font-serif text-brand-dark hover:text-brand-deep transition-colors"
            >
              {catLabel(cat)}
        ...
        <div className="px-6 py-6 border-t border-brand-champagne flex flex-col gap-5">
          <a
            href="#showroom-consultations"
            onClick={() => setMobileMenuOpen(false)}
            className="w-full text-center bg-brand-dark text-white hover:bg-brand-deep transition-colors py-4 rounded-md text-[11px] font-display uppercase tracking-[0.22em] font-semibold"
          >
            {t.nav.book}
          </a>
      ...
      <section className="relative h-[100svh] min-h-[560px] overflow-hidden hero-section bg-brand-night text-white">
        ...
        >
          <source src="https://videos.pexels.com/video-files/1290592/1290592-hd_1920_1080_30fps.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6 sm:px-8">
          ...
          <div className="overflow-hidden mb-4 sm:mb-6 pb-[0.12em]">
            <h1 className="text-[2.6rem] leading-[1.08] sm:text-6xl md:text-7xl lg:text-8xl font-serif font-normal hero-animate text-white max-w-5xl pb-[0.1em]">
              {t.hero.titleA} <span className="italic text-brand-gold font-light">{t.hero.titleEm}</span>
            </h1>
          </div>
          ...
          <div className="overflow-hidden mt-7 sm:mt-9 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 hero-animate">
              <a
                ...
                onMouseLeave={() => triggerCursor("", false)}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-xs tracking-[0.25em] uppercase font-display bg-brand-gold text-brand-night hover:bg-white px-7 py-4 rounded-md transition-all duration-300 font-semibold"
              >
              ...
              <a
                ...
                onMouseLeave={() => triggerCursor("", false)}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-xs tracking-[0.25em] uppercase font-display border border-white/40 bg-white/10 backdrop-blur-md hover:bg-white hover:text-brand-night px-7 py-4 rounded-md transition-all duration-300 text-white"
              >
                {t.hero.ctaSecondary}
              </a>
            </div>
          ...
          <div className="flex animate-infinite-scroll gap-10 sm:gap-20 text-base sm:text-lg md:text-xl tracking-[0.4em] uppercase font-display font-light items-center">
            {[0, 1].map((dup) => (
              <React.Fragment key={dup}>
                ...
                <span className="font-serif italic font-medium tracking-[0.3em]">{t.marquee[1]}</span> <span className="text-brand-deep opacity-60">❀</span>
                <span className="font-display font-bold tracking-[0.25em]">{t.marquee[2]}</span> <span className="text-brand-deep opacity-60">❀</span>
                <span className="font-serif font-normal uppercase tracking-[0.4em]">{t.marquee[3]}</span> <span className="text-brand-deep opacity-60">❀</span>
                ...
                <span className="font-serif italic font-semibold tracking-[0.3em] text-brand-deep">{t.marquee[5]}</span> <span className="text-brand-deep opacity-60">❀</span>
      ...
      <section className="pb-20 sm:pb-24 px-5 sm:px-4 md:px-12 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 md:gap-8">
          {[
            { span: "md:col-span-7", cat: "bouquets", img: "ig/ig03.jpg", cursor: "BOUQUETS" },
            { span: "md:col-span-5", cat: "roses", img: "ig/ig05.jpg", cursor: "ROSES" },
            { span: "md:col-span-5", cat: "arrangements", img: "ig/ig01.jpg", cursor: "ARRANGEMENTS" },
            { span: "md:col-span-7", cat: "weddings", img: "ig/ig10.jpg", cursor: "WEDDINGS" }
          ].map((c, i) => (
            <div
              key={c.cat}
              className={`${c.span} relative h-[320px] sm:h-[380px] md:h-[500px] overflow-hidden rounded-2xl collection-card bg-brand-champagne group cursor-pointer border border-brand-champagne shadow-sm animate-fade-in`}
              onClick={() => {
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-4 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 sm:gap-x-8 gap-y-10 sm:gap-y-16">
            {filteredProducts.map((product) => (
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-brand-champagne border border-brand-champagne transition-all duration-500 shadow-sm group-hover:shadow-md">
                  <img
                    src={product.image}
                ...
                <div className="mt-4 flex-1 flex flex-col justify-between px-0.5 sm:px-1">
                  <div>
                    ...
                    <h4 className="text-base sm:text-lg font-serif font-medium text-brand-dark tracking-wide line-clamp-1 group-hover:text-brand-deep transition-colors duration-300">
                      {productName(product)}
                    </h4>
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6">
          ...
          <div className="mt-9 sm:mt-10 flex justify-center">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-brand-gold hover:bg-white text-brand-night text-xs tracking-[0.25em] font-display uppercase rounded-md transition-all duration-500 shadow-xl font-semibold"
            >
              {t.consult.cta}
            </button>
          </div>
      ...
      <section className="py-20 sm:py-24 max-w-7xl mx-auto px-5 sm:px-4 md:px-12 bg-white">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <h2 className="text-3xl font-serif font-normal text-brand-dark">{t.social.followCta} @{BRAND.handle}</h2>
          <a
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            <a key={i} href={BRAND.instagram} target="_blank" rel="noreferrer" className="block relative aspect-square overflow-hidden group rounded-xl bg-brand-champagne border border-brand-champagne">
              ...
              <li key={p.id}>
                <button onClick={() => { setSelectedProduct(p); setSearchOpen(false); }} className="w-full flex items-center gap-4 group text-left">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="block text-sm font-serif text-brand-dark truncate group-hover:text-brand-deep transition-colors">{productName(p)}</span>
                  </div>
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-3 sm:p-4">
          ...
          <div className="relative bg-white w-full max-w-4xl max-h-[92vh] overflow-y-auto no-scrollbar rounded-2xl shadow-2xl border border-brand-champagne grid grid-cols-1 md:grid-cols-12 z-10 animate-scale-up">
            ...
            <div className="md:col-span-7 p-6 sm:p-10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-serif text-brand-dark tracking-wide">{productName(selectedProduct)}</h3>
